...
export const getTasks = path => dispatch =>{
   ...
   if (path==='me'){
   axios.get(`https://projectavengers.herokuapp.com/api/task/list/${me.userId}`, {
       headers:  {
...
if (path===''){
   axios.get(`https://projectavengers.herokuapp.com/api/task/list`, {
      headers:  {
        'Authorization': `Bearer ${token}`,
       }            
...
export const deleteTask = id => dispatch => {
   const token = localStorage.getItem('token')
   axios.get(`https://projectavengers.herokuapp.com/api/task/delete/${id}`, {
       headers:  {
         'Authorization': `Bearer ${token}`,
        }            
...
export const editTaskStatus = data => dispatch => {
   ...
   axios.patch(`https://projectavengers.herokuapp.com/api/task/update/${data.id}`,
      {title: data.title,
